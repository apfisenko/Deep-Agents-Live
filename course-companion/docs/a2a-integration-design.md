...
> **Статус:** реализовано в Sprint 15 (`CHECKER_MODE=a2a`, ADR 010).
> Код: `subagents/a2a_checker.py`, `subagents/a2a_middleware.py`.
>
> Мы уже видели, что наш чекер автоматически виден снаружи по A2A (agent card +
> `message/send` — полный лог витрины в `../examples/walkthrough/a2a-showcase.txt`).
> Здесь разворачиваем ситуацию на 180°: теперь **чужим становится чекер**,
> а companion — A2A-клиентом.
