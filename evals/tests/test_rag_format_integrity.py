"""Integrity tests for rag-format-facts v001."""
...
MIN_ITEMS = 15
VALID_INTENTS = {"format", "schedule", "recordings"}


def test_rag_format_draft_structure() -> None:
...
def test_rag_format_reviewed_by_gate() -> None:
    ds = load_manifest(MANIFEST)
