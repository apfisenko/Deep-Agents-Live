...
| 2026-07-01 | graphrag-v001 | hybrid RRF (vector+graph+global), reranker off in eval | graphrag/*@v001 | entity@5 multi +0.26, global +0.32 vs baseline | single-hop correctness −0.18 (routing → task 08) | [`graphrag-v001-20260703-itog.md`](graphrag-v001-20260703-itog.md) |
| 2026-07-03 | graphrag-final | agent routing: search_vector/graph/global/text2cypher | graphrag/*@v001 (isolated, 20 items) | sh corr 0.463; mh entity@5 **0.726**; gl entity@5 **0.892** | sh corr −0.069 vs baseline (≥−0.02 miss); faith mixed | [`graphrag-final.md`](graphrag-final.md) — routing OK, sh guard частично |
